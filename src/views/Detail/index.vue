    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/category/${goodDetailData.categories?.[1].id}` }">
            {{ goodDetailData.categories?.[1].name }}
          </el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: `/category/sub/${goodDetailData.categories?.[0].id}` }">
            {{ goodDetailData.categories?.[0].name }}
          </el-breadcrumb-item>
          <el-breadcrumb-item>{{ goodDetailData.name }}</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <!-- 商品信息 -->
          ...
          <div class="goods-info">
            <div class="media">
              ...
              <ul class="goods-sales">
                ...
                <li>
                  <p>商品评价</p>
                  <p>{{ goodDetailData.commentCount }}+</p>
            ...
            <div class="spec">
              <!-- 商品信息区 -->
              <p class="g-name"> {{ goodDetailData.name }} </p>
